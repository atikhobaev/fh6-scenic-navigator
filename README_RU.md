...
Это бесплатный публичный проект с доступными исходниками. Лицензия оригинального кода ожидает решения владельца; [анализ происхождения кода и данных](docs/PROVENANCE_REVIEW.md).
